function page() {
  return (
    <>
      <div className="p-10">
        <h1 className="text-3xl md:text-5xl flex justify-center text-primary p-20 uppercase">
          Dashboard
        </h1>
        <div className="flex-col gap-y-5 flex lg:flex-row justify-around">
          ...
          <div className="stats shadow">
            ...
            <div className="stat">
              ...
              <div className="stat-desc">↗︎ 410 (12%)</div>
            </div>
            ...
            <div className="stat">
              ...
              <div className="stat-desc">↘︎ 250 (5%)</div>
            </div>
          </div>
        </div>
        <div className="flex justify-center items-center  mt-20">
          <ul className="timeline">
            ...
            <li>
              ...
              <div className="timeline-end timeline-box">Future</div>
              <hr />
            </li>
            <li>
              <hr />
